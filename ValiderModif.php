...
$requete = mysqli_query($bdd,"update operation set Num_Cpt='$Num_Cpt',Type_Ope='$Type_Ope' , Date_Ope='$Date_Ope', Validation ='$Validation' , Montant_Ope='$Montant_Ope',Date_Valeur='$Date_Valeur' where Num_Ope='$Num_Ope' ");
	if($requete === false)
  {
